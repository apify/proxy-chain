...
- **`APIFY_SERVICE_ACCOUNT_GITHUB_TOKEN`** is required for the release commit and the GitHub release.
  It is an organization secret, and its account has to be allowed to push to the protected `master`
  branch.
