...
export default class HandlerTunnelChain extends HandlerBase {
    ...
    constructor(options) {
        ...
        //if (!this.srcResponse.socket) this.srcResponse.assignSocket(srcSocket);

        /*} else {
            if (!srcResponse) throw new Error('Either "srcSocket" or "srcResponse" must be provided!');
            this.srcResponse = srcResponse;
            this.srcResponse.shouldKeepAlive = false;
            this.srcResponse.chunkedEncoding = false;
            this.srcResponse.useChunkedEncodingByDefault = false;
            this.srcSocket = srcResponse.socket;
        }*/
